      ...
      return (
        <div className="cgu">
          ...
          <p>Cette application est développée sur un modèle participatif à but non-lucratif, transparent et open-source.</p>
                    <br/>
          <h3> Tarifs </h3>
          <p>L'inscription est gratuite, cependant nous avons tous besoin de manger, d'entretenir des serveurs et de travailler dans la joie
            par conséquent un don est toujours le bienvenu.</p>
